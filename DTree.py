...
"""
生成决策树的算法有三类：ID3、C4.5、CART。ID3是基础，C4.5算法是从ID3的基础上发展而来的。
CART(分类回归树)是一种二叉决策树，它既能用于分类也可以用于回归。

description:
    this module : the implement of decision tree.
    use IG to select the keywords
